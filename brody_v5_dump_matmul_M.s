...
;   __xbrtime_asm_quiet_fence();
   1205c: 4f 08 00 94  	bl	0x14198 <__xbrtime_asm_quiet_fence>
...
;   __xbrtime_asm_quiet_fence();
   120b8: 38 08 00 94  	bl	0x14198 <__xbrtime_asm_quiet_fence>
; }
...
;     __xbrtime_asm_fence();
   12be0: 6b 05 00 94  	bl	0x1418c <__xbrtime_asm_fence>
...
;   __xbrtime_asm_fence();
   133cc: 70 03 00 94  	bl	0x1418c <__xbrtime_asm_fence>
...
;   __xbrtime_asm_fence(); /* wait for all the PEs to reach the barrier */
   134d4: 2e 03 00 94  	bl	0x1418c <__xbrtime_asm_fence>
...
;   LDR X10, [c0]
   14118: 0a 00 40 f9  	ldr	x10, [c0]
;   RET
   1411c: c0 53 c2 c2  	ret	c30

0000000000014120 <__xbrtime_put_u8_seq>:
;   MOV X12, XZR
   14120: ec 03 1f aa  	mov	x12, xzr

0000000000014124 <.put_u8_seq>:
;   LDR X10, [X0]
   14124: 0a 04 c0 e2  	ldur	x10, [x0, #0]
;   ADD X0, X0, X3
   14128: 00 00 03 8b  	add	x0, x0, x3
;   ADD X12, X12, #1
   1412c: 8c 05 00 91  	add	x12, x12, #1            // =1
;   STR X10, [X1]
   14130: 2a 00 c0 e2  	stur	x10, [x1, #0]
;   ADD X1, X1, X3
   14134: 21 00 03 8b  	add	x1, x1, x3
;   CMP X12, X2
   14138: 9f 01 02 eb  	cmp	x12, x2
;   BNE .put_u8_seq
   1413c: 41 ff ff 54  	b.ne	0x14124 <.put_u8_seq>
;   RET
   14140: c0 53 c2 c2  	ret	c30

0000000000014144 <__xbrtime_get_s8_seq>:
;   MOV X12, XZR
   14144: ec 03 1f aa  	mov	x12, xzr

0000000000014148 <.get_s8_seq>:
;   LDR X10, [X0]
   14148: 0a 04 c0 e2  	ldur	x10, [x0, #0]
;   ADD X0, X0, X3
   1414c: 00 00 03 8b  	add	x0, x0, x3
;   ADD X12, X12, #1
   14150: 8c 05 00 91  	add	x12, x12, #1            // =1
;   STR X10, [X1]
   14154: 2a 00 c0 e2  	stur	x10, [x1, #0]
;   ADD X1, X1, X3
   14158: 21 00 03 8b  	add	x1, x1, x3
;   CMP X12, X2
   1415c: 9f 01 02 eb  	cmp	x12, x2
;   BNE .get_s8_seq
   14160: 41 ff ff 54  	b.ne	0x14148 <.get_s8_seq>
;   RET
   14164: c0 53 c2 c2  	ret	c30

0000000000014168 <__xbrtime_put_s8_seq>:
;   MOV X12, XZR
   14168: ec 03 1f aa  	mov	x12, xzr

000000000001416c <.put_s8_seq>:
;   LDR X10, [X0]
   1416c: 0a 04 c0 e2  	ldur	x10, [x0, #0]
;   ADD X0, X0, X3
   14170: 00 00 03 8b  	add	x0, x0, x3
;   ADD X12, X12, #1
   14174: 8c 05 00 91  	add	x12, x12, #1            // =1
;   STR X10, [X1]
   14178: 2a 00 c0 e2  	stur	x10, [x1, #0]
;   ADD X1, X1, X3
   1417c: 21 00 03 8b  	add	x1, x1, x3
;   CMP X12, X2
   14180: 9f 01 02 eb  	cmp	x12, x2
;   BNE .put_s8_seq
   14184: 41 ff ff 54  	b.ne	0x1416c <.put_s8_seq>
;   RET
   14188: c0 53 c2 c2  	ret	c30

000000000001418c <__xbrtime_asm_fence>:
;   DSB SY
   1418c: 9f 3f 03 d5  	dsb	sy
;   ISB
   14190: df 3f 03 d5  	isb
;   RET
   14194: c0 53 c2 c2  	ret	c30

0000000000014198 <__xbrtime_asm_quiet_fence>:
;   DMB SY
   14198: bf 3f 03 d5  	dmb	sy
;   RET
   1419c: c0 53 c2 c2  	ret	c30
